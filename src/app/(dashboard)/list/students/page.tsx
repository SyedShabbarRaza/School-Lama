...
const StudentListPage = async ({
  ...
  //Search query params Functionality
  const query: Prisma.StudentWhereInput = {};
  if (QueryParams) {
    for (const [key, value] of Object.entries(QueryParams)) {
      if (value !== undefined) {
        switch (key) {
          case "teacherId":  //Class of St => Lessons=>Teacher  Results in students of that teacher
          //Simply: To Fetch Students of a specific Teacher
            query.class = {
              lessons: {
                some: {
                  teacherId: value,
